...
logging.info(f"Logging is working.")
logging.debug(f"debug this information")
...
if __name__ == "__main__":
    ...
    for game in games:
        ...
        if st.checkbox(f"{team__1} VS {team__2}"):
            ...
            logging.info(f"Score Difference Probability")

            try:
                logging.info(f"Score Difference Probability is working.")
                diff_cdf = norm.cdf(
                ...
                logging.error(
                    "Score Difference Probability not available", exc_info=True
                )
                data["Score Difference Probability"] = {
                    "1 to 5": None,
                    "6 to 10": None,
            ...
            if main_tab == "Head to Head":
                ...
                logging.info(
                    f"The teams playing head to head are {team__1} VS {team__2}."
                )
                logging.info(
                    f"The teams playing head to head are {team__1} VS {team__2}."
                )
                with col1:
                    try:
                        ...
                        logging.info(
                            f"The dataframe is successful with {team__1} VS {team__2}."
                        )
                        logging.info(
                            f"The dataframe is successful with {team__1} VS {team__2}."
                        )
                        ...
                        logging.error(
                            "Head to Head data frame not available", exc_info=True
                        )
                        logging.error(
                            "Head to Head data frame not available", exc_info=True
                        )
                ...
                with col1:
                    try:
                        ...
                        logging.info(
                            f"Head to Head distribution plots are successful with {team__1} VS {team__2}."
                        )
                        st.bokeh_chart(
                            column(h_2_h_team_2_graph_pdf, h_2_h_team_2_graph_cdf)
                        )
            ...
            if main_tab == "scaled_points_stats":
                ...
                try:
                    ...
                    logging.info(
                        f"The scaled points dataframe is available for {team__1} VS {team__2}."
                    )
                    logging.info(
                        f"The scaled points dataframe is available for {team__1} VS {team__2}."
                    )
                    ...
                    logging.error(
                        "Scaled Points data frame not available for {team__1} VS {team__2}.",
                        exc_info=True,
                    )
                ...
                try:
                    st.bokeh_chart(p_r)
                    logging.info(
                        f"The raw scaled plots are available for {team__1} VS {team__2}."
                    )
                    logging.info(
                        f"The raw scaled plots are available for {team__1} VS {team__2}."
                    )
                    ...
                    logging.error(
                        "Raw scaled plots not available for {team__1} VS {team__2}.",
                        exc_info=True,
                    )
                    st.text("raw scaled plots not available")
                    logging.error(
            ...
            if main_tab == "Head to Head":
                with col2:
                    try:
                        ...
                        logging.info(
                            f"The Head to Head Difference Raw Plots are available for {team__1} VS {team__2}."
                        )
                        logging.info(
                            f"The Head to Head Difference Raw Plots are available for {team__1} VS {team__2}."
                        )
                        ...
                        logging.error(
                            "Head to Head Diff and Raw plots not available for {team__1} VS {team__2}.",
                            exc_info=True,
                        )
                        st.text("Head to Head Diff and Raw plots not available")
                        logging.error(
            ...
            if main_tab == "score_diff_probability":
                ...
                with col2:
                    try:
                        ...
                        logging.info(
                            f"The Score Difference Probability dataframe is available."
                        )
                        st.dataframe(
                            score_diff_probability_df.style.background_gradient(
                                cmap="YlGnBu"
                        ...
                        logging.error(
                            "Score Diff Probability data frame is not available.",
                            exc_info=True,
                        )
                        st.text("Score Diff Probability data frame not available")
                        logging.error(
    ...
    try:
        ...
        logging.error(
            "Illusion image not found so Injury information is not available",
            exc_info=True,
        )
        logging.error(
            "Illusion image not found so Injury information is not available",
